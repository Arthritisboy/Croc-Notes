...
class DeleteTabDialog extends StatefulWidget {
  ...
  const DeleteTabDialog({super.key, required this.tab});

  @override
  State<DeleteTabDialog> createState() => _DeleteTabDialogState();
}
...
class _DeleteTabDialogState extends State<DeleteTabDialog> {
  ...
  void _onTextChanged() {
    setState(() {
      _isConfirmed = _confirmController.text.trim() == widget.tab.name;
    });
  }
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'This will permanently delete this tab and all its checklist items.',
                      style: TextStyle(
                        fontSize: 13,
